 ...
 */
public final class CommandMethodInvoker {
     ...
     * @return method return value (or {@code null} for void handlers)
     */
    public Object invoke(CommandDescriptor root, CommandMethodDescriptor methodDescriptor, Object[] invokeArgs) {
        try {
            methodDescriptor.getMethod().setAccessible(true);
            return methodDescriptor.getMethod().invoke(root.getInstance(), invokeArgs);
