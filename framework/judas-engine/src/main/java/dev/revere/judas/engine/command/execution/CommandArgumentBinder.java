 ...
 * </ol>
 */
public final class CommandArgumentBinder {
    private final CommandExecutionServices executionServices;

    /**
     * Creates an argument binder backed by manager-provided resolver services.
     *
    ...
    /**
     * Resolves and orders invocation arguments for one command handler call.
     *
